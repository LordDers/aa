...
public class Elecciones
{
	public static void main (String args[]) 
	{
		...
		System.out.println("\nNombre, presi, num_afi, votos, gobierna");
		...
		*/
			...
			partidoss.add(new Partido(splitArr[0], splitArr[1], Integer.parseInt.(splitArr[2]), splitArr[3], Integer.parseInt(splitArr[4]), Boolean.parseBoolean(splitArr[5])));*/
